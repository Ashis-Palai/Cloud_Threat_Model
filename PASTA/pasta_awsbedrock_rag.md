...
| 8 | Runtime Controls      | Missing Concurrency/Timeouts <br> **CWE-770 Allocation of Resources Without Limits or Throttling**                | Runtime          | Medium         | Functions without concurrency limits or timeout settings are vulnerable to **Denial of Wallet (DoW)** attacks where attackers invoke long-running functions to incur high cloud costs.                                |
